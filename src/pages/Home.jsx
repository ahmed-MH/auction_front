...
const Home = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-6 py-8">
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-[#003847] to-orange-500 rounded-2xl text-white text-center py-16 px-6 mb-12">
  <h1 className="text-4xl md:text-5xl font-bold mb-4">Your bids, your winnings!</h1>
  ...
  <Link
  to="/products"
  className="bg-white text-orange-600 px-8 py-3 rounded-full font-semibold hover:bg-orange-50 transition-colors text-lg inline-block"
>
  View all auctions
</Link>
  ...
  />
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <div className="bg-orange-50 border-2 border-dashed border-orange-200 rounded-xl p-8 text-center relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-orange-400/10 to-orange-600/10"></div>
            <div className="relative z-10">
              <h3 className="text-xl font-semibold text-orange-800 mb-4">The only case you need.</h3>
          ...
          <div className="bg-orange-50 border-2 border-dashed border-orange-200 rounded-xl p-8 text-center relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-orange-400/10 to-orange-600/10"></div>
            <div className="relative z-10">
              <h3 className="text-xl font-semibold text-orange-800 mb-4">Save up to 30%</h3>
              <button className="bg-orange-600 text-white px-6 py-2 rounded-lg hover:bg-orange-700 transition-colors">
                Bid Now
              </button>
            </div>
